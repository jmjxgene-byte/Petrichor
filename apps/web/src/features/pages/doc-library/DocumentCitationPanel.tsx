...
export function DocumentCitationPanel({ libraryId, documentId, search, onResolved }: { libraryId: string; documentId: string; search: string; onResolved?: (data: DocumentCitationWindow | null) => void }) {
    ...
    }, [libraryId, documentId, search, key, onResolved])
