...
import {
  ...
  CommandItem,
  CommandList,
} from "@/components/extend/ui/command"
import {
  Dialog,
  DialogClose,
  DialogContent,
  ...
  DialogPanel,
  DialogTitle,
} from "@/components/extend/ui/dialog"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { FileThumbnail } from "@/components/extend/ui/file-thumbnail"
...
import { ScrollArea, ScrollAreaPrimitive } from "@/components/extend/ui/scroll-area"
import {
  Select,
  SelectContent,
  SelectItem,
...
import { Tabs, TabsList, TabsTrigger } from "@/components/extend/ui/tabs"

const LazyPDFViewer = React.lazy(() =>
  import("@/components/extend/ui/pdf-viewer").then((mod) => ({
    default: mod.PDFViewer,
  }))
)
const LazyDocxViewerPreview = React.lazy(() =>
  import("@/components/extend/ui/docx-viewer").then((mod) => ({
    default: mod.DocxViewerPreview,
  }))
)
const LazyXlsxViewerPreview = React.lazy(() =>
  import("@/components/extend/ui/xlsx-viewer").then((mod) => ({
