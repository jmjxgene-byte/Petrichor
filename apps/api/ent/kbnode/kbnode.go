...
const (
	// Label holds the string label denoting the kbnode type in the database.
	Label = "kb_node"
	...
	// Table holds the table name of the kbnode in the database.
	Table = "petrichor_kb_node"
)

// Columns holds all SQL columns for kbnode fields.
var Columns = []string{
	FieldID,
	FieldUserID,
...
// OrderOption defines the ordering options for the KBNode queries.
